...
info BYTE '			*************************************************************************',0dh,0ah
	 BYTE '			**                                                                     **',0dh,0ah
	 BYTE '			****  ***--- WELCOME TO REGALRIDE RENTALS: DRIVE YOUR DREAMS ---***  ****',0dh,0ah
	 BYTE '			**                                                                     **',0dh,0ah
	 BYTE '			*************************************************************************',0dh,0ah,0
...
info3 BYTE ' 1. WITH DRIVER = Rs 500/HOUR ',0
info30 BYTE '2.  WITHOUT DIRVER = NO ADDITIONAL CHARGES',0
